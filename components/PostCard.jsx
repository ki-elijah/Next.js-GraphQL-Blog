...
const PostCard = ({ post }) => {
    ...
    return (
        <div className="bg-white shadow-lg rounded-lg p-0 lg:p-8 pb-12 mb-8">
            ...
            <div className="inline-block lg:flex text-center justify-center mb-8 w-full">
                <div className="flex justify-center mb-4 lg:mb-0 w-full lg:w-auto mr-8 items-center">
                    {/*Create a logo and put it in graphql*/}
                    <img
            ...
            <div className="font-medium text-center  items-center text-gray-700">
